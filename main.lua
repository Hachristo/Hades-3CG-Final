...
Backgrounds = {
  love.graphics.newImage("Backgrounds/Hades_Asphodel.jpg"),
  love.graphics.newImage("Backgrounds/Hades_Elysium.jpg"),
  love.graphics.newImage("Backgrounds/Hades_Tartarus.jpg")
}
...
function gameDraw()
  love.graphics.draw(Backgrounds[1],0,0,0,1,1)
  drawPilePlayer:draw()
  drawPileAI:draw()
  for _, card in ipairs(cardTable) do
